...
.setMaterials(["cuenta en azure","instalador de sql Server",'Documentacion'])
.BuildCourse()

const presentacionOnline = new PresntacionOnline('Teams',cursoavanzadoBasedeDatos)
presentacionOnline.presentarCurso()
presentacionOnline.enviarRecordatorio('Tu curso será el día '+ cursoavanzadoBasedeDatos.getStartDate)

cursoavanzadoBasedeDatos.displayCourseInfo()
console.log('*****************************************');


const presentacionOnside = new PresntacionOnSide('Interlomas',cursoavanzadoBasedeDatos)
